  ...
  public: {
    Tables: {
      ...
      cadastro_motorista: {
        ...
        Relationships: [
          {
            foreignKeyName: "cadastro_motorista_cadastro_id_fkey"
            columns: ["cadastro_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "cadastro_motorista_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresa"
            referencedColumns: ["empresa_id"]
      ...
      cadastro_veiculo: {
        Row: {
          ...
          cd_cadastro_veiculo: number | null
          descricao: string | null
          dt_alteracao: string | null
          dt_cadastro: string | null
          empresa_id: number
      ...
      emovimento: {
        ...
        Relationships: [
          {
            foreignKeyName: "emovimento_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
      ...
      emovimento_item: {
        ...
        Relationships: [
          {
            foreignKeyName: "emovimento_item_emovimento_id_fkey"
            columns: ["emovimento_id"]
            isOneToOne: false
            referencedRelation: "emovimento"
            referencedColumns: ["emovimento_id"]
          },
          {
            foreignKeyName: "emovimento_item_produto_id_fkey"
            columns: ["produto_id"]
            isOneToOne: false
      ...
      emovimento_pagamento: {
        Row: {
          condicao_id: number | null
          dt_pagamento: string | null
          emovimento_id: number
          emovimento_pagamento_id: number
          empresa_id: number
          excluido: boolean | null
          n_parcelas: number | null
          nr_autorizacao: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "emovimento_pagamento_emovimento_id_fkey"
            columns: ["emovimento_id"]
            isOneToOne: false
            referencedRelation: "emovimento"
            referencedColumns: ["emovimento_id"]
      ...
      empresa: {
        Row: {
          ...
          nm_aba_lojavirtual: string | null
      ...
      entrega: {
        ...
        Relationships: [
          {
            foreignKeyName: "entrega_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresa"
            referencedColumns: ["empresa_id"]
          ...
          {
            foreignKeyName: "entrega_motorista_id_fkey"
            columns: ["motorista_id"]
            isOneToOne: false
            referencedRelation: "cadastro_motorista"
            referencedColumns: ["motorista_id"]
          },
          {
            foreignKeyName: "entrega_veiculo_id_fkey"
            columns: ["veiculo_id"]
            isOneToOne: false
            referencedRelation: "cadastro_veiculo"
      ...
      entrega_item: {
        ...
        Relationships: [
          {
            foreignKeyName: "entrega_item_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresa"
            referencedColumns: ["empresa_id"]
          ...
          {
            foreignKeyName: "entrega_item_entrega_id_fkey"
            columns: ["entrega_id"]
            isOneToOne: false
            referencedRelation: "entrega"
            referencedColumns: ["entrega_id"]
          },
          {
            foreignKeyName: "entrega_item_movimento_id_fkey"
      ...
      fator_conversao: {
        Row: {
          cd_fator_conversao: number | null
          dt_alteracao: string | null
          dt_cadastro: string | null
          empresa_id: number
          excluido: boolean | null
      ...
      fiscal_config: {
        Row: {
          ...
          ssl_crypt_lib: string | null
          ssl_http_lib: string | null
          ssl_lib: string | null
          ssl_type: string | null
          ssl_xml_sign_lib: string | null
          ...
          verificar_validade_cert: boolean | null
      ...
      fiscal_mdf_condutor: {
        ...
        Relationships: [
          {
            foreignKeyName: "fiscal_mdf_condutor_cadastro_id_fkey"
            columns: ["cadastro_id"]
            isOneToOne: false
            referencedRelation: "cadastro"
            referencedColumns: ["cadastro_id"]
          ...
          {
            foreignKeyName: "fiscal_mdf_condutor_condutor_id_fkey"
            columns: ["condutor_id"]
            isOneToOne: false
            referencedRelation: "cadastro_motorista"
            referencedColumns: ["motorista_id"]
      ...
      fiscal_mdf_manifesto: {
        ...
        Relationships: [
          {
            foreignKeyName: "fiscal_mdf_manifesto_rota_id_fkey"
            columns: ["rota_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fiscal_mdf_manifesto_transportador_id_fkey"
      ...
      fiscal_nfe_cabecalho: {
        ...
        Relationships: [
          {
            foreignKeyName: "fiscal_nfe_cabecalho_cadastro_id_fkey"
            columns: ["cadastro_id"]
            isOneToOne: false
            referencedRelation: "cadastro"
            referencedColumns: ["cadastro_id"]
    ...
    Functions: {
      ...
      fu_get_parametro_publico:
        ...
        | {
            Args: { _empresa_id?: number; _url_link_vendas?: string }
            Returns: {
              id: number
              xcor_botao: string
              xcor_botao_negativo: string
      ...
      fu_is_superuser: { Args: { _user_id: string }; Returns: boolean }

...
const XEstoqueGridCols: IGridColumn[] = [
  ...
  { key: "estoque_fisico", label: "Qt. Física", width: "120px", align: "right", getValue: (r) => fmt2(r.estoque_fisico) },
  { key: "estoque_reservado", label: "Qt. Reservada", width: "120px", align: "right", getValue: (r) => fmt2(r.estoque_reservado) },
  { key: "estoque_disponivel", label: "Qt. Disponível", width: "120px", align: "right", getValue: (r) => fmt2(r.estoque_disponivel) },
];
        ...
        {XInnerTab === "cadastro" ? (
          <div className="space-y-3">
              ...
              <div className="space-y-2">
                {XEstMode !== "view" && (
                  <div className="grid grid-cols-[1fr_120px_100px_100px_auto] gap-2 mb-2 items-end bg-slate-50 dark:bg-slate-900/50 p-2 rounded-md border border-border/60">
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-muted-foreground mb-1 uppercase">Est. Mín.</label>
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-muted-foreground mb-1 uppercase">Est. Padrão</label>
                      <input type="text" value={XEstForm.estoque_padrao} onChange={e => setXEstForm(p => ({ ...p, estoque_padrao: e.target.value }))}
                        className={`w-full border border-border rounded px-2 py-1 text-sm text-right ${XBgEdit} focus:ring-2 focus:ring-ring outline-none`} />
                    </div>
                    <div className="flex gap-1">
                      <button onClick={handleEstSalvar} className="px-3 py-1 text-xs bg-emerald-600 text-white rounded font-bold hover:bg-emerald-700">Salvar</button>
                      <button onClick={() => setXEstMode("view")} className="px-3 py-1 text-xs bg-slate-200 text-slate-700 rounded font-bold hover:bg-slate-300">Sair</button>
                    </div>
                  </div>
                )}
                ...
                <DataGrid
                  ...
                  toolbarLeft={
                    <>
                      ...
                      <ToolbarBtn icon={<SquarePen size={14} />} label="Editar" onClick={handleEstEditar} disabled={XEstIdx < 0} color="warning" />
                      ...
                      <ToolbarBtn icon={<Filter size={14} />} label="Filtrar" onClick={() => setXEstShowFilters(!XEstShowFilters)} color="info" />
                    </>
                  }
                />
                {XEstoques.length === 0 && (
            ...
            {XSubTab === "codbarras" && (
              <div className="space-y-2">
                {XBarraMode !== "view" && (
                  <div className="grid grid-cols-[1fr_auto] gap-2 mb-2 items-end bg-slate-50 dark:bg-slate-900/50 p-2 rounded-md border border-border/60">
                    <div>
                      <label className="block text-[10px] font-bold text-muted-foreground mb-1 uppercase">Código de Barras *</label>
                      <input
                        type="text"
                    ...
                    <div className="flex gap-1">
                      <button onClick={handleBarraSalvar} className="px-3 py-1 text-xs bg-emerald-600 text-white rounded font-bold hover:bg-emerald-700">Salvar</button>
                      <button onClick={() => setXBarraMode("view")} className="px-3 py-1 text-xs bg-slate-200 text-slate-700 rounded font-bold hover:bg-slate-300">Sair</button>
                    </div>
                  </div>
                )}
                ...
                <DataGrid
                  ...
                  toolbarLeft={
                    <>
                      ...
                      <ToolbarBtn icon={<SquarePen size={14} />} label="Editar" onClick={handleBarraEditar} disabled={XBarraIdx < 0} color="warning" />
                      <ToolbarBtn icon={<Trash2 size={14} />} label="Excluir" onClick={handleBarraExcluir} disabled={XBarraIdx < 0} color="destructive" />
                      <ToolbarBtn icon={<RefreshCw size={14} />} label="Recarregar" onClick={() => XCurrentRecord && loadSubData(XCurrentRecord.produto_id)} color="info" />
                      <ToolbarBtn icon={<Filter size={14} />} label="Filtrar" onClick={() => setXBarraShowFilters(!XBarraShowFilters)} color="info" />
                    </>
                  }
                />
                {XBarras.length === 0 && (
                ...
                <fieldset className="border border-border rounded p-3">
                  ...
                  {XConvMode !== "view" && (
                    <div className="grid grid-cols-[1fr_1fr_100px_auto] gap-2 mb-2 items-end bg-slate-50 dark:bg-slate-900/50 p-2 rounded-md border border-border/60">
                      ...
                      <div className="flex gap-1">
                        <button onClick={handleConvSalvar} className="px-3 py-1 text-xs bg-emerald-600 text-white rounded font-bold hover:bg-emerald-700">Salvar</button>
                        <button onClick={() => setXConvMode("view")} className="px-3 py-1 text-xs bg-slate-200 text-slate-700 rounded font-bold hover:bg-slate-300">Sair</button>
                      </div>
                    </div>
                  )}
                  ...
                  <DataGrid
                    ...
                    toolbarLeft={
                      <>
                        ...
                        <ToolbarBtn icon={<SquarePen size={14} />} label="Editar" onClick={handleConvEditar} disabled={XConvIdx < 0} color="warning" />

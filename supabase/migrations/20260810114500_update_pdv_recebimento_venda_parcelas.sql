-- Migration: 20260810114500_update_pdv_recebimento_venda_parcelas.sql
-- Description: Updates fu_pdv_registrar_recebimento_venda to correctly query the number of installments and interval-based deadlines from condicao_pagamento, and registers version 1.18.43.
...
-- Register version 1.18.43
DELETE FROM public.sistema_versoes WHERE versao = '1.18.43';
INSERT INTO public.sistema_versoes (versao, titulo, detalhes, autor, fase, tecnologias)
VALUES (
  '1.18.43',
  'Geração de Parcelas PDV Ajustada',
  'PDV: Ajustada a função fu_pdv_registrar_recebimento_venda para obter qtd_parcelas diretamente de condicao_pagamento e recalcular prazos corretos em tipo_prazo = F quando prazos individuais estão zerados usando o intervalo.',
  'AI Antigravity',
  'Desenvolvimento',

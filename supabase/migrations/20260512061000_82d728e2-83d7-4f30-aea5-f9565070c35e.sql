CREATE OR REPLACE FUNCTION public.fu_calcular_impostos_movimento(p_movimento_id bigint, p_modelo text DEFAULT '55'::text, p_serie text DEFAULT '001'::text, p_nr_nota text DEFAULT NULL::text)
 RETURNS bigint
 LANGUAGE plpgsql
 SECURITY DEFINER

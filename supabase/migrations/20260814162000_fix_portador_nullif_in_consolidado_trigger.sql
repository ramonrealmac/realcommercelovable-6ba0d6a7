-- Migration: 20260814162000_fix_portador_nullif_in_consolidado_trigger.sql
-- Description: Updates fu_financeiro_baixa_consolidacao trigger to use NULLIF(v_portador_id, 0) preventing foreign key violations on financeiro_consolidado.

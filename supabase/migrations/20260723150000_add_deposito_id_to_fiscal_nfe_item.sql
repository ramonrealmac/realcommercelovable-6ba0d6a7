-- Migration: 20260723150000_add_deposito_id_to_fiscal_nfe_item.sql
-- Description: Adds deposito_id to fiscal_nfe_item and updates fn_processa_nfe_estoque to use it.

ALTER TABLE public.fiscal_nfe_item ADD COLUMN deposito_id bigint REFERENCES public.deposito(deposito_id);
